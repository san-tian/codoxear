...
use codoxear_backend_rs::schedules::{rust_schedule_sweep_enabled, spawn_schedule_sweep_worker};
...
async fn main() {
    ...
    if rust_schedule_sweep_enabled() {
        spawn_schedule_sweep_worker(state.config.clone());
    }
