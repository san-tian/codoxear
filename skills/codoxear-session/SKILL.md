...
Use the bundled scripts in this skill to operate Codoxear/Nova sessions through the public HTTP API. The scripts log in with `CODEX_WEB_PASSWORD`, `--password`, or the Codoxear repo `.env`.
